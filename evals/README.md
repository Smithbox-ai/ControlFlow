...
- **Pass 3:** Cross-scenario structural regression testing (213 checks).
...
- **Pass 9:** Drift detection (`drift-detection.test.mjs` — 34 checks).

Test suite total: **370 total checks**.
