...
7. Are there missing dependency assumptions, version assumptions, or unpinned external
   contracts?
...
10. Do security, access control, or operability concerns deserve stronger gates than
