...
- Apply the Minimum Viable Change Ladder before adding code, phases, dependencies, or abstractions:
  1. Does this need to exist for the accepted scope?
...
- Do not simplify away trust-boundary validation, data-loss prevention, security, accessibility, rollback guidance, or explicitly requested behavior.
