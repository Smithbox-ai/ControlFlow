...
│   └── controlflow-claude-code/   # Claude Code plugin (3 skills, 0 agents, standalone)
...
- **3 skills, 0 plugin agents:** Planning, verification, and review are skills that run inline in the main context. There are no plugin subagents — verification is adversarial-by-construction instead of relying on isolated verifier contexts.
